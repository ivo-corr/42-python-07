from ex0.creatures import CreatureFactory, FlameFactory, AquaFactory


def test_factory(fac: CreatureFactory) -> None:
...
def fight(fac_one: CreatureFactory, fac_two: CreatureFactory) -> None:
